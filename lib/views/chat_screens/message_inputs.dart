                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(color: darkGrey.withOpacity(0.5),fontSize: 12,fontWeight: FontWeight.w500)
                        ),
                      ),
                    ),
                  ),
              ...
              child: Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    isDense: true,
                    border: InputBorder.none,
                    hintText: 'Type a message...', hintStyle: TextStyle(color: darkGrey.withOpacity(0.5),fontSize: 12,fontWeight: FontWeight.w500)
                  ),
                ),
              ),
            ),
